package com.example.asus.practicaanimaciones;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        frames[0] = (ImageView)findViewById(R.id.imagen1);
        frames[1] = (ImageView)findViewById(R.id.imagen2);
        frames[2] = (ImageView)findViewById(R.id.imagen3);
        frames[3] = (ImageView)findViewById(R.id.imagen4);
        frames[4] = (ImageView)findViewById(R.id.imagen5);
        frames[5] = (ImageView)findViewById(R.id.imagen6);
        frames[6] = (ImageView)findViewById(R.id.imagen7);
        frames[7] = (ImageView)findViewById(R.id.imagen8);
        frames[8] = (ImageView)findViewById(R.id.imagen9);
